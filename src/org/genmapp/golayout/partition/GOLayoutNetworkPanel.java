...
//	private static final long serialVersionUID = -7102083850894612840L;
	 ...
	 * @param desktop
	 */
	public GOLayoutNetworkPanel(final CytoscapeDesktop desktop) {
		super();
		this.cytoscapeDesktop = desktop;

		root = new GOLayoutNetworkTreeNode("Network Root", "root");
			...
			if (e.isPopupTrigger()) {
				...
				if (selected != null && selected.length != 0) {
					...
					for (int i = 0; i<selectedItemCount; i++) {
						...
						final String networkID = (String) ((GOLayoutNetworkTreeNode) treePath.getLastPathComponent())
						                   .getNetworkID();
